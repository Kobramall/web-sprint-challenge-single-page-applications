...
const App = () => {
  ...
  const initialErrors = {size:"", sauce:"", topping1: false, topping2:false, topping3:false, sub:false, special:"", name:""} 
  ...
  function submit(){
        const newPizza = {
          ...
          topping: ["Pepperoni", "Sausage", "Canadian Bacon"].filter(hob => !!formData[hob]),
