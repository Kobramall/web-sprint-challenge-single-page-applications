...
console.log(props.value.sub);
console.log(props.value.special);
console.log(props.value.topping1);
console.log(props.value.topping2);
console.log(props.value.topping3);
console.log(props.value.name);
console.log(props.value.sauce)
